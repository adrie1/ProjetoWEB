...
public class ProjetoService {
	...
	public Projeto saveProjeto(Projeto projeto) throws ExistingProjetoSameNameException {
		if (projetoRepository.findByNome(projeto.getNome()).isPresent())
			throw new ExistingProjetoSameNameException("Já possui um projeto cadastrado com o nome: " + projeto.getNome());
