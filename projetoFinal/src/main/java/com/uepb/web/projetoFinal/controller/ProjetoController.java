...
public class ProjetoController {
	...
	public ResponseEntity<?> saveProjeto(@RequestBody ProjetoDTO projetoDTO, UsuarioDTO usuarioDTO) throws TipoUsuarioAlunoException {
		try {
            ...
            return new ResponseEntity<>(projetoService.saveProjeto(projeto, usuario), HttpStatus.CREATED);
